...
\begin{figure}[ht]
    ...
    \label{fig:low_lat_cld_fbk_components}
\end{figure}

\secref{sec:spread_of_gm_cld_fbks_PPE} has found that the low cloud amount feedback is the largest single contributor to the spread of Isca PPE, but the analysis are based on the global mean values. But which region is most sensitive is the focus
