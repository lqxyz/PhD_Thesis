...
\section{Cloud feedback calculation}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{{figs/cre_change/fig2_Soden2004_PRP_CRF_comparison}.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.65\linewidth]{{figs/cre_change/Soden_Held_cld_fbk_and_delta_CRF}.png}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.9\linewidth]{{figs/cre_change/cld_fbk_from_kernel_CRF_adjust_forcing}.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.65\linewidth]{{figs/cre_change/cloud_masking_effect}.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{{figs/cre_change/cld_kernel_Zelinka}.pdf}
