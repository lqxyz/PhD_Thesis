...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{{figs/change_of_CRE/cld_fbk_composited_by_omega500_percentile}.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{{figs/change_of_CRE/low_cld_fbk_composited_by_omega500_percentile}.pdf}
...
Previous studies such as \cite{Bony2005} has found that the marine boundary layer clouds are at the heart of tropical cloud feedback uncertainties in climate models. 

\figref{fig:cld_fbk_composite_w500_percentile}

\subsection{Cloud controlling factor analysis}
\label{sec:cld_control_factor}

\cite{Scott2020} \cite{Myers2021} 
