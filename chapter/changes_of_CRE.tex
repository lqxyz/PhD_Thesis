...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\linewidth]{{figs/change_of_CRE/global_mean_cld_fbk_decomp_scatter}.pdf}
    \caption{Global mean cloud feedback decomposition.}
