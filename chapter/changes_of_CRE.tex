...
As introduced in \chapref{ch:introduction} and \chapref{ch:simple_cld_scheme}, clouds heat the Earth by absorbing and re-emitting the longwave radiation, and cool the Earth by reflecting the incoming solar radiation, the so called cloud radiative effect. But currently how the cloud radiative effect change under global warming (i.e., cloud feedback) remains unclear, which is still the leading cause for the inter-model spread of equilibrium climate sensitivity (ECS) in climate models \citep{Cess1990intercomparison,Cess1996cloud,Webb2006contribution,Vial2013,Zelinka2020causes,Sherwood2020}. 

\citep{Bony2005,Webb2006contribution,Webb2013coupling,Vial2013,Zelinka2016insights}. 

Low cloud feedback is the leading causes for the inter-model spread 
\citep{Bony2005,Webb2006contribution,Webb2013coupling,Vial2013,Zelinka2016insights}
