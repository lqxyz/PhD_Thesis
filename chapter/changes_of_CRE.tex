...
\end{figure}
 ...
 Based on the comparisons in \secref{sec:cmp_cld_fbk_method_result}, we find the cloud radiative kernel based diagnostics and $\Delta R/\Delta T_s$ method can provide a relative accurate calculation of cloud feedbacks, and thus in this section all the feedbacks are calculated in this way.
