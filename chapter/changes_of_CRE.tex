...
\begin{figure}[ht]
    ...
    \caption{Comparison of sum of ISCCP joint histogram and total cloud amount from Isca.}
...
At first, the diagnostics from COSP are compared to the Isca native outputs to make sure it is correctly implemented. To do so, the sum of cloud cover over all bins of the joint histogram is compared with the model diagnostic of total cloud cover which model computes without using the ISCCP simulator \citep[e.g.,][]{Zelinka2012computing1,Klein2013climate}.
