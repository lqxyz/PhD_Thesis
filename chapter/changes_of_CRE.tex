...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{{figs/change_of_CRE/covariance_contribution_breakdown_with_err}.pdf}
...
Following \cite{Caldwell2016quantifying} and \cite{Zelinka2016insights}, we quantify the contribution of cloud types to the spread of net cloud cloud feedback as follows:
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
where $X_i$ are low/non-low cloud amount,  altitude, optical depth feedbacks and residuals.
