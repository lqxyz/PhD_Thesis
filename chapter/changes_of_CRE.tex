...
In \chapref{ch:simple_cld_scheme} we have evaluated the climatology simulated by the simple cloud scheme when implemented in Isca, and how the cloud radiative effect responses to climate change is to be investigated in this chapter. 
