...
%Not only for the climatology, clouds also play 

In addition, clouds have impact on the atmospheric circulation via their interactions with radiation \citep{Voigt2020review}, which can finally influence the regional climate, as reviewed in \secref{sec:cloud_circulation_coupling}.
