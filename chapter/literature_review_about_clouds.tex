...
Previous studies have shown that many parameterizations can have impact on the spread of cloud feedbacks among GCMs. For example, \cite{Sherwood2014spread} pointed out that the strength of convective mixing between the lower and middle tropical troposphere can explain about half of the variance in climate sensitivity estimated by GCMs.
