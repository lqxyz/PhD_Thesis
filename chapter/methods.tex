...
\begin{equation}
	...
	\label{eq:z700}
\end{equation}
In \Eqref{eq:eis}, $\Gamma_{m}$ is the moist-adiabatic potential temperature gradient, $z_{700}$ is the height of 700 hPa, $z_{LCL}$ is the height of LCL. In \Eqref{eq:gamma_m}, $L_v$ is the latent heat of vaporization, $q_s$ is the saturation mixing ratio, $R_a$ and $R_v$ are the gas constants
for dry and water vapor, respectively, $g$ is the gravitational acceleration, and $c_p$ is the specific heat of air at constant pressure. In \Eqref{eq:z700}, $T_0$ and $p_0$ are the surface temperature and pressure respectively. 
