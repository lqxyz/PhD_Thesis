...
For Earth-like simulations, Isca can use land options with various complexities. For example, Isca can run with slab ocean without lands \citep[aquaplanet setup; e.g.,][]{Geen2019processes}, can run with idealized continent shapes \citep[e.g.,][]{Pietschnig2019} and can also run with realistic continents and topography \citep[e.g.,][]{Geen2018regime}.
