...
% Topography file
The topography and land/sea mask are from the ERA-Interim reanalysis \citep{Dee2011}. The original topography is smoothed to reduce the Gibbs ripples that arise from the truncated spherical harmonic expansion (The method is provided by Greg Colyer and Ruth Geen). The final topography over land is displayed in \figref{fig:input_sst_ice}a.
