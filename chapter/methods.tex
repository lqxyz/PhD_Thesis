...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.6\linewidth]{{figs/methods/input_sst_sic_annual_mean}.png}
...
\begin{figure}[ht]
    ...
    \caption[Global and annual mean of longwave, shortwave and net cloud radiative kernels]{Global, annual, and ensemble mean (a) longwave, (b) shortwave and (c) net cloud radiative kernels. Adapted from Fig. 1 of \cite{Zelinka2012computing1}}
