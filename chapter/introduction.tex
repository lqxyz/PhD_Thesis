...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\linewidth]{{figs/literature_review/ECS_contributions}.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\linewidth]{{figs/literature_review/Schematic_partial_cloud_cover_in_gridbox}.pdf}
