...
\begin{enumerate}
    ...
    \item Could we build a relatively simple cloud scheme for the GCMs that could grasp the key features of cloud fields?
...
\end{enumerate}
The first question intends to understand the roles of climate feedbacks (except surface albedo and cloud) in climate system, while the rest questions focus on the clouds, cloud feedback and its uncertainty through a potential simple cloud scheme.
