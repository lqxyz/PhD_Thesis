...
Climate feedbacks are the processes in the climate system that can either amplify or dampen its responses to the external perturbations \citep{Bony2006,Soden2006}. Understanding these feedbacks is key to demystify the unresolved problems in climate system. For example, the climate sensitivity, i.e., how the global mean surface temperature change in response to increased greenhouse gas, is one of the central problems in climate change studies \citep[e.g.,][]{Bony2006,Stocker2013,Sherwood2020}, and narrowing down the range of climate feedbacks, especially the range of cloud feedbacks, is crucial to constrain the climate sensitivity \citep[e.g.][]{Cess1990intercomparison,Webb2006contribution,Vial2013,Zelinka2020causes,Myers2021}. Despite the efforts payed by the climate communities, the general circulation models (GCMs) still do not have consensus on the sign of global mean cloud feedback \citep{Zelinka2020causes}, whose uncertainty is still the leading cause of intermodel spread of climate sensitivity \citep{Ceppi2017,Zelinka2020causes}. Therefore, to understand the underlying causes for cloud feedback uncertainty \citep[e.g.,][]{Bony2005,Vial2013,Zhang2013CGILS,Qu2014,Webb2013origins,Webb2015,Zelinka2016insights,Geoffroy2017} and to find the possible constraints for it \citep[e.g.,][]{Qu2015positive,Klein2017low,Myers2016,Scott2020,Myers2021,Ceppi2021observational} are key tasks in current climate research.

%Despite the efforts payed by previous studies, the cloud feedback is still the leading cause of cl

% Not only for the climate sensitivity, climate feedback
% The global mean surface temperature change in response to greenhouse gas emissions, namely the climate sensitivity, is one of the key problems of climate change studies \citep[e.g.][]{Cess1990intercomparison,Bony2006,Stocker2013,Sherwood2020,Zelinka2020causes}. \cite{Sherwood2020} 

%The estimates of climate sensitivity depend critically on the climate feedbacks, the processes that can either amplify or dampen the responses of climate system to the external perturbations. 

The goal of this thesis is to to understand the climate feedbacks through the idealized climate models, and the following scientific questions are to be addressed:
