...
The global mean surface temperature change in response to greenhouse gas emissions, namely the climate sensitivity, is one of the key problems of climate change studies \citep[e.g.][]{Bony2006,Stocker2013,Sherwood2020,Zelinka2020causes}.

The estimates of climate sensitivity depend critically on the climate feedbacks, the processes that can either amplify or dampen the responses of climate system to the external perturbations. The goal of this thesis is to to understand the climate feedbacks through the idealized climate models.
