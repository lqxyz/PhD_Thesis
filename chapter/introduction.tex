...
\begin{enumerate}
    ...
    \item Could we build a relatively simple cloud scheme to investigate the cloud related problems? If so, could the scheme be used to explore the underlying causes of the intermodel spread of cloud feedback in climate models? 
\end{enumerate}
