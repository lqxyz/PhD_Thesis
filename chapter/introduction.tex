...
Equilibrium climate sensitivity (ECS) is the equilibrium (i.e., $\Delta R=0$) response of $T_s$ to the radiative forcing from a doubling of CO$_2$ ($F_{2\times CO_2}$):
\begin{equation}
