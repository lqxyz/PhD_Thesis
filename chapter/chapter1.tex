...
\begin{figure}[tbhp] % [H]
	\centering
	\includegraphics[width=1.0\linewidth]{figs/chp1/ts_diff.pdf}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\linewidth]{{figs/chp1/poleward_ht_diff_compnts_diff_schemes}.pdf}}
...
The changes of the surface albedo do have influence on the atmopspheric energy transports in these experiments, although the degree of influence is different. The experiments performed with BOG radiation scheme have the largest changes after varying the albedo, the runs with RRTM radidation schemes have moderate changes, while the ones with Frierson schemes have the least effect (Figures \ref{fig:ht_transport}a, d and g), which are much clearer when checking the differences of the experiments in Figures \ref{fig:ht_transport_diff}. Compared to the dry static energy transport, the latent heat transport contributes a larger portion to the total atmospheric at 40$^\circ$ poleward (Figures \ref{fig:ht_transport} and \ref{fig:ht_transport_diff}). Previous studies have shown that an increase in atmospheric heat transport can cause midtropospheric warming in polar region \citep[e.g.,][]{Screen2012}, which can explain indirectly the polar amplification in experiments under seasonal or annual mean insolations \citep{Kim2018}.  Here we also examined the temperature change in polar region ($70^\circ$ northward) both at surface and mid-troposphere (450-700hPa) (Figure \ref{fig:delta_ht_ts}). The results show strong linear relationships between the total AET change across $70^\circ$ and either the surface temperature change and ($R^2=0.97$, Figure \ref{fig:delta_ht_ts}a) or mid-troposphere temperature change ($R^2=0.90$, Figure \ref{fig:delta_ht_ts}b), implying that the heat transport is associated with the polar amplification both at surface and mid-troposphere under insolation conditions.
...
\begin{figure}[tbhp]
	\centering
	\includegraphics[width=0.8\linewidth]{figs/chp1/heat_transport_delta_ts.pdf}
...
\begin{figure}[tbhp]
	...
	%\includegraphics[width=1.0\linewidth]{figs/chp1/delta_ts_decomp_q.pdf}
...
\section{Discussion and Summary}
 ...
 \begin{figure}
	\includegraphics[width=0.9\textwidth]{figs/chp1/contributions_to_polar_amplification.pdf}
...
\end{figure}
 ...
 \begin{figure}
	\includegraphics[width=1\textwidth]{figs/chp1/pa_dynamic.pdf}
