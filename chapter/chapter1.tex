...
\begin{figure}[tbhp] %
	\centering
	\includegraphics[width=.6\linewidth]{figs/chp1/kernels_byrne}
...
\begin{figure}[tbhp] %
	\centering
	\includegraphics[width=.6\linewidth]{figs/chp1/kernels_frierson}
...
\begin{figure}[tbhp]
	\centering
	\includegraphics[width=.6\linewidth]{figs/chp1/kernels_rrtm}
...
\begin{figure}[tbhp]
	\centering
	\includegraphics[width=1\textwidth]{figs/chp1/all_zonalmean_feedbacks}
...
\begin{figure}[tbhp]%[H]
	\centering
	%\includegraphics[width=1.0\linewidth]{{figs/chp1/tsurf_diff_ctrl_m_others_RdBu_kav7}.pdf}
	\includegraphics[width=1.0\linewidth]{{figs/chp1/tsurf_diff_others_m_ctrl_RdBu_kav7_2}.pdf}
...
%\begin{figure}[tbhp] %[H]
%	\centering
%	\includegraphics[width=1.0\linewidth]{{figs/chp1/tsurf_diff_zonal_mean_others_m_ctrl}.pdf}
...
\begin{figure}[tbhp] % [H]
	\centering
	\includegraphics[width=1.0\linewidth]{figs/chp1/ts_diff}
...
\begin{figure}[tbhp] 
	\centering
	\includegraphics[width=1.0\linewidth]{{figs/chp1/temp_vert_profile_diff_others_m_ctrl_RdBu_symmetric}.pdf}
...
\begin{figure}[tbhp] % [H]
	\centering
	\includegraphics[width=0.8\linewidth]{figs/chp1/temp_profile}
...
\begin{figure}[tbhp] % [H]
	\centering
	\includegraphics[width=1.0\linewidth]{figs/chp1/sphum_diff}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=1.0\textwidth]{figs/chp1/ht_bog_no_moisture.pdf}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=1.0\textwidth]{figs/chp1/compare_bog_moisture_feedback/hadley_cell_bog_without_moisture_feedback.pdf}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=1.0\textwidth]{figs/chp1/compare_bog_moisture_feedback/ht_diff_bog_no_moisture.pdf}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=0.5\textwidth]{figs/chp1/linear_relation_Delta_T_ht_no_moisture_bog.pdf}
...
\begin{figure}[tbhp]
	\centering
	\makebox[\linewidth]{
	\includegraphics[width=1.1\textwidth]{figs/chp1/sfc_q_diff_gradient}}
...
\begin{figure}[H]
	\centering
	\makebox[\linewidth]{
	\includegraphics[width=1.1\linewidth]{{figs/chp1/poleward_ht_diff_compnts_diff_schemes_0.3_0.38_0.33_0.27}.pdf}}
...
\begin{figure}[H]
	\centering
	\hspace{-1cm}
	\includegraphics[width=1.\linewidth]{{figs/chp1/heat_transport_bog_frierson_components_diff_test}.pdf}
...
\begin{figure}[tbhp]
	\centering
	\includegraphics[width=0.8\linewidth]{figs/chp1/heat_transport_delta_ts}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=1.0\linewidth]{{figs/chp1/fig_three_rad_scheme_coolwarm_4_albedos/hadley_cell_byrne}.pdf}
...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=1.0\linewidth]{{figs/chp1/fig_three_rad_scheme_coolwarm_4_albedos/vcomp_vert_profile_all_three_albedos}.pdf}
...
\begin{figure}[tbhp]
	\centering
	%\includegraphics[width=1.0\linewidth]{figs/chp1/delta_ts_decomp}
	\includegraphics[width=1.0\linewidth]{figs/chp1/delta_ts_decomp_q}
...
%\begin{figure}[tbhp] %[H]
%	\centering
%	\includegraphics[width=0.8\linewidth]{figs/chp1/ts_decomp/delta_ts_decomp_fixed_q_byrne}
