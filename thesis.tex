...
\documentclass[a4paper,onehalfspacing,twoside,12pt]{exeterthesis}
...
\title{Understanding the cloud radiative effect response to climate change with a simple cloud scheme}
\author{Qun Liu}
\date{December 2020}
...
\include{chapter/methods_for_cloud_feedback}
