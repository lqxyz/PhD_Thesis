...
\begin{figure}[tbhp]
	\centering
	\includegraphics[width=1.0\linewidth]{{figs/chp1/Hansen2005_forcings}.png}
...
\begin{figure}[tbhp] %[H]%
	\centering
	\includegraphics[width=.8\linewidth]{figs/chp1/fig7_Soden2008}
...
\begin{figure}[tbhp] %
	\centering
	\includegraphics[width=.8\linewidth]{figs/chp1/Feldl2017}
...
\begin{figure}[tbhp]
	\centering
	\includegraphics[width=0.8\textwidth]{{figs/chp1/lw_optical_depth}.pdf}
...
\begin{figure}[tbhp] %
	\centering
	\includegraphics[width=.6\linewidth]{figs/chp1/Kim2018_lapserate}
